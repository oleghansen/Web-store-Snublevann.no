...
namespace Nettbutikk.Models
{
    public class Customer
    {
        ...
        [RegularExpression(@"(^[a-zA-Z]+$)", ErrorMessage = "Ugyldig fornavn")]
        public String firstname { get; set; }
        [Display(Name = "Etternavn")]
        [Required(ErrorMessage = "Etternavn må oppgis")]
        [RegularExpression(@"(^[a-zA-Z]+$)", ErrorMessage = "Ugyldig etternavn")]
        ...
        [RegularExpression(@"(^[a-zA-Z])", ErrorMessage = "Ugyldig adresse")]
        ...
        [RegularExpression(@"(^[a-zA-Z0-9])", ErrorMessage = "Ugyldig brukernavn")]
